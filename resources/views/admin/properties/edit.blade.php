                ...
                <div class="body">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <label class="form-label">Ten tai san</label>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-float">
                        ...
                        <div class="help-info">trieu dong</div>
                    </div>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <label class="form-label">So phong tam</label>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line">
                            ...
                            <label class="form-label">Dien tich</label>
                        </div>
                    ...
                    <hr>
                    <div class="form-group">
                        <label for="tinymce-nearby">Gan voi khu vuc</label>
            ...
            <div class="card">
                ...
                <div class="body">
                    ...
                    <div class="gallery-box">
                        ...
                        <button type="button" class="btn btn-info btn-lg right" id="galleryuploadbutton">Tai anh len</button>
                    </div>
                </div>
            </div>
                ...
                <div class="body">
                    ...
                    <div class="form-group form-float">
                        <div class="form-line {{$errors->has('active') ? 'focused error' : ''}}">
                            ...
                            <select name="active" class="form-control show-tick">
                                ...
                                <option value="1" {{ $property->active== '1' ? 'selected' : '' }}>Hien thi</option>
                                <option value="0" {{ $property->active== '0' ? 'selected' : '' }}>Khong hien thi</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line {{$errors->has('purpose') ? 'focused error' : ''}}">
                            <label>Kieu tai san</label>
                            <select name="purpose" class="form-control show-tick">
                                <option value="">-- Chon mot --</option>
                                <option value="sale" {{ $property->purpose=='sale' ? 'selected' : '' }}>Ban</option>
                                <option value="rent" {{ $property->purpose=='rent' ? 'selected' : '' }}>Cho thue</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group form-float">
                        <div class="form-line {{$errors->has('type') ? 'focused error' : ''}}">
                            ...
                            <select name="type" class="form-control show-tick">
                                <option value="">-- Chon mot --</option>
                                <option value="house" {{ $property->type=='house' ? 'selected' : '' }}>Nha</option>
                                <option value="apartment" {{ $property->type=='apartment' ? 'selected' : '' }}>Can ho</option>
                            </select>
                        </div>
                    </div>
